                ...
                <div class="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarText">
                        <ul className="navbar-nav me-auto mb2 mb-lg-0 d-flex">
                            ...
                            <Link to='/portfolio' onClick={changePage}><li className="nav-item" href="/portfolio" ><div className={`nav-link  ${currentPage === 'portfolio' ? 'active' : 'text-light'}`} value='portfolio' >Portfolio</div></li></Link>
